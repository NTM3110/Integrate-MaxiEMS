package io.openems.edge.bms.demo;
...
public class BmsDemoImpl extends AbstractOpenemsModbusComponent
		implements BmsDemo, ModbusComponent, OpenemsComponent{
	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this,
				new FC3ReadRegistersTask(0x0001, Priority.HIGH,
						this.m(BmsDemo.ChannelId.BATTERY_VOLTAGE, new UnsignedWordElement(0x0001),
								ElementToChannelConverter.chain(SIGNED_MAGNITUDE_CONVERTER,
										ElementToChannelConverter.DIRECT_1_TO_1)),
						this.m(BmsDemo.ChannelId.BATTERY_TEMPERATURE, new UnsignedWordElement(0x0002),
								ElementToChannelConverter.chain(SIGNED_MAGNITUDE_CONVERTER,
										ElementToChannelConverter.DIRECT_1_TO_1)),
						this.m(BmsDemo.ChannelId.BATTERY_INTERNAL_RESISTANCE, new UnsignedWordElement(0x0003),
								ElementToChannelConverter.chain(SIGNED_MAGNITUDE_CONVERTER,
										ElementToChannelConverter.DIRECT_1_TO_1))));
	}
